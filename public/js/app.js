...
var root = '/';
var router = new (navigo__WEBPACK_IMPORTED_MODULE_0___default())(root);
document.addEventListener("DOMContentLoaded", function () {
  router.on('publique-uma-vaga', function () {
    return (0,_pages__WEBPACK_IMPORTED_MODULE_1__["default"])('publique-uma-vaga');
  });
  router.resolve();
});
...
/* harmony export */ });
/* harmony import */ var _publish_job__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./publish_job */ "./resources/js/pages/publish_job.js");

var pages = {
  'publique-uma-vaga': {
    init: _publish_job__WEBPACK_IMPORTED_MODULE_0__["default"]
  }
};
...
function getSelectedPage(cleanedUrl) {
  var pagesCopy = pages;
  var initFunction;
  cleanedUrl.forEach(function (element, index, array) {
...
function returnPage(url) {
  ...
  var cleanedUrl = splitedUrl[0].length > 0 ? splitedUrl : splitedUrl.slice(1, splitedUrl.length);
  return getSelectedPage(cleanedUrl)();
}

/***/ }),

/***/ "./resources/js/pages/publish_job.js":
/*!*******************************************!*\
  !*** ./resources/js/pages/publish_job.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function getElements() {
  ...
  var city_state = document.getElementsByName('city_state')[0];
  return {
    zipcode: zipcode,
    state: state,
    city: city,
...
function createInteractions(elements) {
  var zipcode = elements.zipcode,
      state = elements.state,
      city = elements.city,
      city_state = elements.city_state;
  var typingTimer;
  var doneTypingInterval = 1000;

  function getAddressByZipcode(event) {
    var inputValue = event.target.value;
    var apiUrl = "https://brasilapi.com.br/api/cep/v2/".concat(inputValue);
    return /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
      var zipcodeErrorMessage, formButton, response, data;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              zipcodeErrorMessage = document.getElementById('zipcode_error_message');
              formButton = document.getElementById('form_button');
            ...
            case 13:
              ...
              city_state.value = "".concat(data.city, ", ").concat(data.state);
  ...
  zipcode.addEventListener('paste', function () {
