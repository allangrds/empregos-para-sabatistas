...
class StoreJobRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'how_to_apply_email' => 'required_without_all:how_to_apply_telephone,how_to_apply_site|max:500',
            'how_to_apply_telephone' => 'required_without_all:how_to_apply_email,how_to_apply_site|max:500',
            'how_to_apply_site' => 'required_without_all:how_to_apply_email,how_to_apply_telephone|max:500',
